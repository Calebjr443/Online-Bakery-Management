...
<body class="loginbackgimg">
    ...
    <div class="login logindec img-curve ">
        ...
        <form action="index.php" method="POST" class="text-center">
            ...
            <a href="<?php echo $url; ?>addcustomer.php" class="btn btn-primary">Sign Up now </a><br><br><br>
            <a href="<?php echo $url; ?>admin/login.php" class="btn btn-primary">Sign in as admin</a>
